...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('calendarios', function (Blueprint $table) {
            ...
            $table->Integer('rebotes_visita')->nullable();
            $table->Integer('rebotes_casa')->nullable();
            $table->Integer('asistencias_visita')->nullable();
            $table->Integer('asistencias_casa')->nullable();
