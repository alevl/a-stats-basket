...
<html lang="en">
    <head>
        ...
        <meta name="og:description" content="Estadisticas de basket">
                ...
                <div class="relative px-4 py-4 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div class="max-w-md mx-auto">
                        <div style="text-align: center">
                            <img src="{{ asset('storage/sistema/A-Stats-basket.png') }}" class="responsive1" style="position:relative; margin:auto" width="200px">
                        </div>
